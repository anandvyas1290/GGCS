            ...
            <div className="max-w-screen-lg lg:max-w-screen-xl mx-auto py-10">
                ...
                <div className='md:flex py-10'>
                    <div className="w-full md:w-1/2 mx-3">
                        <div className="my-10">
                            <p className="text-transparent text-lg bg-clip-text bg-gradient-to-r from-purple-700 to-pink-800">Looking for best SEO results?</p>
                            ...
                            <h6 className="text-base mb-4 text-grey2">
                                So I said down the you owt to do with me absolutely bladdered,
                                amongst what a plonker brolly baking.
                            </h6>
                            <div className='my-10'>
                                <div>
                                    <h5 className="text-base mb-1">Desktop Score</h5>
                                    <div className="w-full md:w-2/3 bg-gray-200 rounded-full h-3 mb-4 dark:bg-gray-100">
                                        <div className="bg-green-600 h-3 rounded-full dark:bg-green-500" style={{ width: "90%" }}></div>
                                    </div>
                                </div>
                                <div>
                                    <h5 className="text-base  mb-1">Desktop Score</h5>
                                    <div className="w-full md:w-2/3 bg-gray-200 rounded-full h-3 mb-4 dark:bg-gray-100">
                                        <div className="bg-yellow-600 h-3 rounded-full dark:bg-yellow-500" style={{ width: "75%" }}></div>
                                    </div>
                                </div>
                            </div>
                            <div className="mt-5">
                    ...
                    <div className="w-full md:w-1/2 mx-3 px-10 py-10 ">
                        <div className='relative'>
                            ...
                            <div >
                                <img src={ClientImg} alt="" className='absolute bottom-0 left-0' />
                                <img src={InputImg} alt="" className='absolute top-32 -left-10' />
                                <img src={StatImg} alt="" className='absolute top-20 -right-10 shadow-2xl ' />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div className='flex items-center justify-between'>
                            <div className='flex items-baseline'>
                                ...
                                <div>
                                    <h3 className='text-4xl text-white'>180+</h3>
