...
function Contact(props) {
    return (
        <div className="relative bg-gray-100 z-[1]">
            ...
            <div className="max-w-screen-lg lg:max-w-screen-xl mx-auto flex py-10">
                <div className="w-1/2">
                    <div className="my-10">
                        ...
                        <h2 className='text-4xl sm:text-5xl font-semibold mt-5 mb-4'>Lets Work <br />Together</h2>
                ...
                <div className="w-1/2 rounded-lg bg-white px-10 py-10 before:bg-homeGradient before:-top-4 before:left-0 before:absolute">
                    <di className="flex flex-wrap" >
                        ...
                        <div className="w-full  border-2 relative rounded-xl my-3 bg-gray-100 ">
                    ...
                    <div className="w-full mt-3">
                        <PrimaryBtn
                            size="px-8 py-3"
                            bgColor="bg-primaryBtn"
                            className="border-2 rounded-full border-primaryBtn w-full"
                        >
                            Send Message
                        </PrimaryBtn>
                    </div>
