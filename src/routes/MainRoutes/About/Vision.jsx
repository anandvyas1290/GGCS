...
const counterData = [
    {
        Icon: counter1,
        num: "25 +",
        label: <p className=' text-base pl-3'>
            Years <br />
            Of Experience
        </p>
    },
            ...
            <Container>
                    ...
                    <div className='flex'>
                        <div className='w-1/2'>
                            <div className='bg-red-100 px-14 py-14 rounded-lg'>
                                <span >
                                    <img src={mission} alt="mission" className='mb-5' />
                                </span>
                    ...
                    <div className='flex'>
                        ...
                        <div className='w-3/5 relative'>
                            <div className='bg-green-100 px-14 py-14 rounded-lg absolute -top-10 left-10'>
                                <span >
                                    <img src={purpose} alt="purpose" className='mb-5' />
                                </span>
                                <p className='text-lg text-gray-700'>
                ...
                <div className='flex justify-between'>
                    {counterData?.map((item, i) => {
                        return (
                            <div className=' flex items-center relative z-10 py-6' key={i}>
